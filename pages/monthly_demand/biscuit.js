        ...
        <div ref={printRef} className="mt-2 p-2 mx-4 print:mx-10 space-y-2 border rounded-md print:shadow-none print:border-none print:rounded-none">
            ...
            <div className="flex flex-col space-y-2 md:flex-row md:justify-between md:space-x-2 md:space-y-0">
                ...
                <div className="w-full md:w-1/2 border border-gray-400 pb-4">
                    ...
                    <PmView name='Milk Biscuit 45gm Wrapper' unit='' pm={Milk_Biscuit?.wrapper} />
                    <PmView name='Milk Biscuit 45gm Carton' unit='Pcs' pm={Milk_Biscuit?.carton} />
                    ...
                    <PmView name='Both Side Gum Tape 1"' unit='Pcs' pm={result.getTotalPmItem(pm, 'gumTapBoth')} />
                    <PmView name='P.P Handgloves' unit='Pcs' pm='1000' />
                </div>
            </div>
