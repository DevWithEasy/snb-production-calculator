...
import snacksProduct from "../../utils/productGenerate/snacks";
import snacks from "../../utils/quantity/snacks";
...
export default function AddProduct({sections}){
    ...
    const createProduct = {...product,id : product.name.split(" ").join("_"),ingredients : snacksProduct(quantity)}
