        ...
        <div className="absolute w-full h-screen left-0 top-0 z-20 flex justify-center items-center bg-slate-500/70">
            <div className="relative bg-white rounded-md p-4 space-y-2">
                ...
                <div className="space-y-2 relative">
                    ...
                    {!hide ? <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="absolute right-3 top-8 w-6 h-6" onClick={()=>handleHide()}>
                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z" />
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                    </svg> :
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="absolute right-3 top-8 w-6 h-6" onClick={()=>handleHide()}>
                ...
                <div className="py-2">
                    <button className="px-6 py-2 bg-slate-500 text-white rounded" onClick={()=>login()}>Login</button>
                </div>
            </div>
        </div>
    )
